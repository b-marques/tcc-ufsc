...
\input{utils/snippets.tex}
% arruma o overflow nas referencias quando o tipo é numérico
...
% programa/curso.
\coordenador{Prof. Dr. José Francisco Danilo de Guadalupe Correa Fletes}
...
\begin{document}
    ...
    \include{chapters/02-fundamentacao-teorica}

    % Capitulo de revisão de literatura
    \include{chapters/03-trabalhos-relacionados}

    % Capitulo de Desenvolvimento
    \include{chapters/04-otimizacao-pskelmppa}

    % Capitulo de Resultados
    \include{chapters/05-resultados}

    % Capitulo de Contribuições Acadêmicas
    \include{chapters/06-contribuicoes}
    
    % Capitulo de Conclusão
    \include{chapters/07-conclusao}
    ...
    %     % Imprime uma página indicando o início dos apêndices
        ...
        \include{aftertext/apendice_codigo_fonte}
        \include{aftertext/apendice_artigo}
    \end{apendicesenv}
