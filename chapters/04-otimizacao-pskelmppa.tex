...
As etapas acima mencionadas estão retratadas na \autoref{fig:block2d}, para sua implementação foi utilizada a nova \api de comunicação asíncrona (\async). Abaixo elas são descritas em mais detalhes:
